...
\def \experience
{
    \job{Software Engineer and Research Assistant}
        {Dec 2016}{Present}
        {Applied Artificial Intelligence Institute (\asis), Burwood}
    ...
    \job{Resident Tutor}
        ...
        {Residential tutor focusing on teaching second-year \href{https://handbook.unimelb.edu.au/2017/subjects/swen20003}{object-oriented programming} using Java.}
        {
