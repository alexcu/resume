...
\def \education
{
    \edu{Bachelor of Science (Professional Software Development)}
        ...
        {
            Key Disciplines in Web and iOS Application Design/Development, Concurrent and Functional Programming, Data Structure Theory, Programming Languages Development, User Interface and Experience Design, Database Design and Programming
        }
